...

{
    ...
    public class ThicknessSolver
    {
        ...
        TemperatureSolverC1 temperatureSolver;
        ...
        public TemperatureSolverC1 TemperatureSolver { get => temperatureSolver; }
        public int ThicknessSolveStep { get => thicknessSolveStep; }
        public double ThicknessSolverResidual { get => thicknessSolverResidual; }
        public double TargetLayerThickness { get => ThicknessCalculate.Calculate.LayerList[ThicknessCalculate.TargetLayerIndex].Thickness; set => ThicknessCalculate.Calculate.LayerList[ThicknessCalculate.TargetLayerIndex].Thickness = value; }
        ...
        public ThicknessSolver(ThicknessCalculate _calculate)
        {
            ...
            temperatureSolver = TemperatureSolverFactory.CreateSolver(calculate.Calculate);
    ...
    public class ThicknessSolverC1 : ThicknessSolver
    {
        ...
        public override void Solve()
        {
            ...
            OnSolverStart();
            double[] thickness = { TargetLayerThickness, TargetLayerThickness+0.0005 };
            double[] target = { 0, 0 };
